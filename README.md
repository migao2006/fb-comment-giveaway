...
不用安裝 App 或瀏覽器擴充套件。在 Facebook 一般貼文頁執行 Bookmarklet，工具會直接從目前頁面整理已載入的主留言，並在裝置本機完成篩選與抽獎。
...
4. 點選「FB 留言抽獎」書籤，在頁內面板掃描或繼續載入留言。
5. 設定關鍵字、日期、排除貼文作者、正取及備取人數後開始抽獎。

## 功能

- 半自動展開更多主留言，顯示進度並可隨時停止。
- 取得頁面中可見的姓名、留言內容、個人頁連結及可取得的時間。
